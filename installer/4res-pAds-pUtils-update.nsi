; ------------------------------------------------------------------
; wget で最新リビジョンを取得する
!system '..\..\util\soft\wget\wget.exe http://p.plustar.jp/repv.php?t=padsu -O Plustar_Version.nsh' ignore
...
Name       "${PS_PRODUCTNAME}"
OutFile    "..\pExtADs-pUtils-update.exe"
...
section "Install"
  ...
  ;; インストール統計を取得する
  !insertmacro Plustar_Stats_Install_Action "pADsu" "u" "${PLUSTAR_VERSION}"
