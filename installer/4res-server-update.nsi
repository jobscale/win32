...
section "Install"
  ...
  Delete "$SMPROGRAMS\Plustar ExTrapper\クリップ.lnk"
  ...
  Delete "$SMPROGRAMS\Plustar ExTrapper\クライアントアンインストーラー.lnk"
  Delete "$SMPROGRAMS\Plustar ExTrapper\コンソール初期化ツール.lnk"
  Delete "$SMPROGRAMS\Plustar ExTrapper\※ExTrapper for Resourceマニュアル.lnk"
  ...
  ;; 旧版でアンインストーラの実態を包括していたが現在はWEBでダウンロード
