...
!Define PS_PRODUCTNAME  "プラスター ExTrapper for Resource クリーンマシン構成情報"
...
Name       "${PS_PRODUCTNAME}"
OutFile    "..\pExTrapper4Res-ClearHard.exe"
...
section "Install"
  ...
  StrCpy $0 "プラスター ExTrapper for Resourceのマシン構成データの初期化を行いますか？$\r$\n$\r$\n"
  ...
  ;; インストール統計を取得する
  !insertmacro Plustar_Stats_Install_Action "resch" "i" "${PLUSTAR_VERSION}"
