...
/**
 * The state of a pAds processing thread.
 */
struct client_state
{
...
/**
 * A data file used by pAds.  Kept in a linked list.
 */
struct file_list
{
   /**
...
#define FORCE_PREFIX "/PADS-FORCE"
...
/** URL for the pAds home page. */
#define HOME_PAGE_URL     "http://www.plustar.jp/"

/** URL for the pAds user manual. */
 ...
 */
#define CGI_SITE_1_HOST "pl.plustar.jp"
#define CGI_SITE_2_HOST "pad.plustar.jp"
...
#define ENDTRACE() _endtrace()
#elif 1
#define TRACE(x) _critical()
#define ENDTRACE() if (0)
#else
#define TRACE(x) if (0)
#define ENDTRACE() if (0)
#endif
