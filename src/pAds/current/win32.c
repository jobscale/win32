...
#if (defined(_WIN32) || defined(WINVER)) && defined(_MSC_VER) && defined(_DEBUG)
...
/**
 * A short introductory text about pAds.  Used for the "About" box
 * or the console startup message.
 */
const char win32_blurb[] =
"pAds version " VERSION " for Windows\n"
"Copyright (C) 2006-2011 the pAds (" HOME_PAGE_URL ")\n";
...
void InitWin32(void)
{
   ...
   {
#ifndef _WIN_CONSOLE
      MessageBox(NULL, "Cannot initialize WinSock library", "pAds Error", 
