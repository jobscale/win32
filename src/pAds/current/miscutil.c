...
#ifdef USE_PADS_STRLCPY
/*********************************************************************
 *
 * Function    :  pads_strlcpy
 *
 ...
 *
 * Returns     :  The length of the string that pads_strlcpy() tried to create.
 *
 *********************************************************************/
size_t pads_strlcpy(char *destination, const char *source, const size_t size)
{
   if (0 < size)
   {
...
#endif /* def USE_PADS_STRLCPY */


#ifndef HAVE_STRLCAT
/*********************************************************************
 *
 * Function    :  pads_strlcat
 *
 ...
 *          3  :  size: Size of destination buffer.
 *
 * Returns     :  The length of the string that pads_strlcat() tried to create.
 *
 *********************************************************************/
size_t pads_strlcat(char *destination, const char *source, const size_t size)
{
 ...
 *                for pAds: style changed, #ifdefs for _WIN32 added
