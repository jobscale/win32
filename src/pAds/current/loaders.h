...
extern char *read_config_line(char *buf, size_t buflen, FILE *fp, unsigned long *linenum, const char* fname);
...
extern jb_err simple_read_line(FILE *fp, char **dest, int *newline, const char* fname);
