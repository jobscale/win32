;
; File:
;   $Source: /cvsroot/ijbswa/winsetup/pAds_winthreads.nsi,v $
;
; Purpose:
...
Icon "pAds.ico"
UninstallIcon "uninstall_pAds.ico"
...
Section "" ; (default section)
	...
	; Close pAds.exe if it is running (user is upgrading) to prevent in-use errors.
...
Section "Add to Start Menu"
	...
	CreateShortCut "$SMPROGRAMS\Privoxy\Privoxy.lnk" "$INSTDIR\pAds.exe"
...
Section "Run automatically at startup"
	CreateShortCut "$SMSTARTUP\Privoxy.lnk" "$INSTDIR\pAds.exe" "" "" 0 SW_SHOWMINIMIZED
SectionEnd
